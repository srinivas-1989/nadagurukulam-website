                        ...
                        return editingDisc === d.id ? (
                          <tr key={d.id} style={{ borderBottom: '1px solid var(--border)', background: 'var(--bg-saffron)' }}>
                            ...
                            <td style={{ padding: '8px' }}>
                              ...
                              {discEditStructure === 'semester' && <><label style={{ fontSize: '11px', color: 'var(--text-soft)' }}>Years{editDiscCatLimit?<span style={{color:'var(--text-faint)'}}> (max {editDiscMaxYears})</span>:null}<br /><input type="number" min="1" max={editDiscMaxYears} value={discEditYearCount} onChange={e => setDiscEditYearCount(e.target.value)} placeholder="Years" style={{ padding: '6px', border: '1px solid var(--border)', borderRadius: '4px', width: '100%', marginBottom: '6px' }} /></label><label style={{ fontSize: '11px', color: 'var(--text-soft)' }}>Sems/Year<br /><input type="number" min="1" max="4" value={discEditSemPerYear} onChange={e => setDiscEditSemPerYear(e.target.value)} placeholder="Sems/Year" style={{ padding: '6px', border: '1px solid var(--border)', borderRadius: '4px', width: '100%' }} /></label></>}
                            </td>
                            <td style={{ padding: '8px' }}>
